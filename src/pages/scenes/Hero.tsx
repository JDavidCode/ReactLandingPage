  ...
  return (
    ...
    >
      <div className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 lg:py-12 py-4">
        ...
        <div className="mx-auto max-w-4xl font-display text-5xl font-bold tracking-normal  text-white/80 sm:text-7xl flex flex-col">
          <TypingEffect
        ...
        <a
          className="bg-sky-900 rounded-xl text-white px-3 py-2 sm:mt-10 mt-8 hover:bg-sky-800 transition"
          href="#services"
        >
          Get started
        </a>
